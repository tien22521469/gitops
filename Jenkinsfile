                    ...
                    script {
                        withCredentials([
                            ...
                            sh """
                                ...
                                mv aws-iam-authenticator /tmp/aws-iam-authenticator
                                export PATH=\$PATH:/tmp

                                # Cập nhật kubeconfig với xác thực IAM
                                aws eks update-kubeconfig --name ${EKS_CLUSTER_NAME} --region ${AWS_REGION} --role-arn arn:aws:iam::449663538285:user/admin
